...
final class ModernRaycastBridge {
    ...
    static void onClientTick(Object event) {
        try {
            ...
            RaycastResult result = ModernGhostHandBridge.apply(minecraft, player);
            if (result == null && ModernForgeEventBridge.enabled("Reach") && canReach(minecraft, player)) {
    ...
    static Object hitResultEntity(Object minecraft) {
        Object entity = currentHitEntity(minecraft);
        return entity == null ? entityFromHitResult(lastHitResult) : entity;
    }

    static Object currentHitEntity(Object minecraft) {
        return entityFromHitResult(hitResult(minecraft));
    }
    ...
    private static Object createVec3(Vec3 vector) {
        return toMinecraftVec(vector);
    }

    static Object toMinecraftVec(Vec3 vector) {
    ...
    static Vec3 fromMinecraftVec(Object vector) {
        if (vector == null) {
            return null;
        }
        return new Vec3(doubleField(vector, "x", "f_82479_"),
                doubleField(vector, "y", "f_82480_"),
                doubleField(vector, "z", "f_82481_"));
    }
