...
public class WaterMark implements ICommand {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		if (args.length >= 1) {
			...
			gq.yozakura.util.minecraft.Helper.sendMessage("Watermark set to " + Client.name);
			return;
		}
		gq.yozakura.util.minecraft.Helper.sendMessage(getCommandUsage(sender));
	}
