...
import static gq.vapulite.module.ModuleType.World;
...
public class NoFall extends Module {
    ...
    private void mlg() {
        ...
        if (this.containsItem(heldItem, Items.water_bucket) && mc.thePlayer.rotationPitch >= 70.0f) {
            ...
            if (object != null && object.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && object.sideHit == EnumFacing.UP) {
