...
public class TargetESP extends Module {
    ...
    public TargetESP() {
        ...
        this.addValues(mode, alpha, radius, height, pulseSpeed, lineWidth, shader, throughWalls, auraTarget,
    ...
    private void drawTarget(EntityLivingBase target, float partialTicks, float fade) {
        ...
        int primary = target.hurtTime > 0 ? 0xFFFF6270
        ...
        boolean usingShader = Boolean.TRUE.equals(shader.getValue())
                && TargetShader.begin(primary, secondary, alphaScale, time, hurtPulse);
        try {
