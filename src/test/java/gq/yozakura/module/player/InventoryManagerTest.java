...
public class InventoryManagerTest {
    ...
    @Test
    public void armorActionUnequipsWorseArmorBeforeEquippingTheBestSlot() {
        assertEquals(InventorySelection.ArmorAction.UNEQUIP_CURRENT,
                InventorySelection.chooseArmorAction(12, 5, true));
        assertEquals(InventorySelection.ArmorAction.EQUIP_BEST,
                InventorySelection.chooseArmorAction(12, 5, false));
        assertEquals(InventorySelection.ArmorAction.NONE,
                InventorySelection.chooseArmorAction(5, 5, true));
    }
}
